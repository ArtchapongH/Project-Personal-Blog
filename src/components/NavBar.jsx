        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" sideOffset={-4} className="sm:hidden w-screen rounded-none mt-2 flex flex-col gap-6 py-10 px-6">
            <div className="px-6 pb-6 flex flex-col gap-3 md:hidden">
              <button className="w-full rounded-full border border-black/10 py-4 text-base font-medium text-black">
                Log in
              </button>
              <button className="w-full rounded-full bg-black py-4 text-base font-medium text-white">
                Sign up
              </button>
            </div>
          </DropdownMenuContent>
