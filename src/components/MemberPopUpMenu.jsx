function MemberPopUpMenu() {
    return(
        ...
        <div className="bg-gray-100 min-h-screen flex items-center justify-center">
            ...
            {/* Card */}
            <div className="w-full max-w-sm md:max-w-md bg-[#FCFBF8] rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="pb-2">
                    ...
                    {/* Logout */}
                    <a href="#"
                    className="flex items-center gap-4 px-6 py-3 hover:bg-red-50 transition">
